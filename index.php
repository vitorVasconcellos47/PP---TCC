...
<!-- Gráfico bar -->
  ...
  <div class="box"> <h2> Bairros de Londrina </h2> <canvas id="myChart2"></canvas></div>
</div>
    ...
    <div class="user">
      <div class="formBx">
        <div>
          ...
          <input type="text" id="denend" placeholder="Endereço de destino">
          <input type="text" id="dennum" placeholder="Número da residência" maxlength="4" onkeypress="return event.charCode >= 48 && event.charCode <= 57">

          
          <select type="select" id="dencause">
...
<div class="archive">
          <header> Arquivados </header>
          <form action="#">
          <input type="file" id="denarchive" class="file-input" name="file" hidden>
          <i><img src="_gallery/cloud.png" class="cloud"></i>
          <p> Procurar Arquivo para Carregar </p>
          </form>
            <section class="progress-area"></section>
            <section class="uploaded-area" style="color:#D3CFC9"></section>
  </div>
...
<footer>
  <div class="footer-content">
    <div class="footBox">
      <div class="fbox"> <img class="tam1" src="_gallery/marista.png"> </div>
      <div class="fbox"> <img class="tam2" > </div>
    </div>
  </div>
<div class="footer-bottom">
  <p>Copyright &copy;2022 iLume. designed by <span>BEVG</span></p>
</div>
</footer>
